...
if __name__ == "__main__":
    ...
    # 执行命令：python test_case4.py --task 2 --machine 6 --position 9 --heuristic 0 --base_num 14
    ...
    tasks[0].release = []
    tasks[1].occupy = [[1], [2,7]]
    tasks[1].release = [[0], [1]]
    tasks[2].occupy = [[3,8]]  #
    tasks[2].release = [[3,8]]
    tasks[3].occupy = [[1], [4]]  #
    tasks[3].release = [[1], [2,7]]
    tasks[4].occupy = [[5]]  #
    tasks[4].release = [[5]]
    tasks[5].occupy = [[1], [0]]  #
    tasks[5].release = [[1], [4]]
    ...
    tasks[7].release = []
    tasks[8].occupy = [[1], [2,7]]
    tasks[8].release = [[6], [1]]
    tasks[9].occupy = [[3,8]]  #
    tasks[9].release = [[3,8]]
    tasks[10].occupy = [[1], [4]]  #
    tasks[10].release = [[1], [2,7]]
    tasks[11].occupy = [[5]]  #
    tasks[11].release = [[5]]
    tasks[12].occupy = [[1], [6]]  #
    ...
    tasks[2].occupy_dependency[0] = 1
    tasks[2].release_dependency[0] = 2
    tasks[3].release_dependency[1] = 1
    tasks[9].occupy_dependency[0] = 8
    tasks[9].release_dependency[0] = 9
    tasks[10].release_dependency[1] = 10
