...
if __name__ == "__main__":
    ...
    # 执行命令：python test_case7.py --task 2 --machine 5 --position 9 --heuristic 0 --base_num 9
    ...
    tasks[0].release = []
    tasks[1].occupy = [[1], [2,6]]
    tasks[1].release = [[0], [1]]
    tasks[2].occupy = [[5]]  #
    tasks[2].release = []
    tasks[3].occupy = [[1], [3,7]]  #
    tasks[3].release = [[1], [5]]
    tasks[4].occupy = [[4,8]]  #
    tasks[4].release = [[4,8]]
    tasks[5].occupy = [[1], [0]]  #
    tasks[5].release = [[1], [2,6]]
    tasks[6].occupy = []  #
    tasks[6].release = [[0]]
    tasks[7].occupy = [[1],[5]]  # 0：冰箱1出Plate
    tasks[7].release = [[1],[3,7]]
    tasks[8].occupy = []
    tasks[8].release = [[5]]
    ...
    tasks[4].occupy_dependency[0] = 1
    tasks[4].release_dependency[0] = 4
    tasks[5].release_dependency[1] = 1
    tasks[7].release_dependency[1] = 1
