...
if __name__ == "__main__":
    ...
    # 执行命令：python test_case8.py --task 1 --machine 6 --position 10 --heuristic 0 --base_num 16
    ...
    tasks[9].release = [[1], [2]]
    tasks[10].occupy = [[1],[7]]  #
    tasks[10].release = [[1],[4]]
    tasks[11].occupy = [[8]]  # 0：冰箱1出Plate
    tasks[11].release = [[8]]
    tasks[12].occupy = [[1],[0]]
    tasks[12].release = [[1],[6]]
    tasks[13].occupy = [[1],[9]]  #
    tasks[13].release = [[1],[7]]
    tasks[14].occupy = []  # 0：冰箱1出Plate
    tasks[14].release = [[0]]
    tasks[15].occupy = []
    tasks[15].release = [[9]]
    ...
    # tasks[3].occupy_dependency[1] = 1
    # tasks[5].release_dependency[1] = 1
    # tasks[6].release_dependency[1] = 1
    # tasks[10].occupy_dependency[1] = 9
    # tasks[12].release_dependency[1] = 9
    # tasks[13].release_dependency[1] = 9
    ...
    positions[8].machine = 4
    positions[9].machine = 5
